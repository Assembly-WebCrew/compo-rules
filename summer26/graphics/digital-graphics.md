...
- Write the techniques used in the submission form (Partyman) while submitting the image, maximum of 5 words (i.e. "digital painting", "completely vector based", "Composition of multiple methods").
